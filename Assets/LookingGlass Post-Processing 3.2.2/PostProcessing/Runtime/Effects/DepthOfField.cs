...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class DepthOfField : PostProcessEffectSettings
    {
        ...
        /// </summary>
        [Min(0.0001f), Tooltip("Distance to the point of focus.")]
        ...
        /// </summary>
        [Range(0.05f, 32), Tooltip("Ratio of aperture (known as f-stop or f-number). The smaller the value is, the shallower the depth of field is.")]
        ...
        /// depth of field is.
        /// </summary>
        [Range(1, 300), Tooltip("Distance between the lens and the film. The larger the value is, the shallower the depth of field is.")]
