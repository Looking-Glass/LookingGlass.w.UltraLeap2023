...
namespace LookingGlass.Editor {
    ...
    public class QuiltCaptureEditor : UnityEditor.Editor {
        ...
        private void OnEnable() {
            ...
            customScreenshotSettingsProperty.FindPropertyRelative(nameof(QuiltCaptureOverrideSettings.renderSettings)).isExpanded = true;
        }
        ...
        private void OverrideSettingsGUI(QuiltCaptureOverrideSettings overrideSettings) {
            EditorGUILayoutHelper.ReadOnlyRenderSettings(overrideSettings.renderSettings);
