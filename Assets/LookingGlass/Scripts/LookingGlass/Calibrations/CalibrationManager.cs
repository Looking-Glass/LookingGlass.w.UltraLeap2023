...
namespace LookingGlass {
    /// <summary>
    /// A callback for receiving notifications when calibrations are refreshed from LookingGlass Core.
    /// </summary>
    ...
    public static class CalibrationManager {
        ...
        /// <summary>
        /// An event that gets fired when calibrations are refreshed from LookingGlass Core.
        /// </summary>
