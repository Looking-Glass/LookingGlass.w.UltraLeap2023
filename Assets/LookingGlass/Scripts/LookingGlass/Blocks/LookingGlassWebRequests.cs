    ...
    public static class LookingGlassWebRequests {
        ...
        public static GraphQLAPI BlocksAPI {
            get {
                ...
                blocksAPI.SetAuthToken(LookingGlassUserSystem.AccessToken);
                return blocksAPI;
            }
        }
        ...
        internal static UnityWebRequest CreateRequestToGetFileUploadURL(string fileName) {
            ...
            request.SetRequestHeader("Authorization", "Bearer " + LookingGlassUserSystem.AccessToken);
        ...
        internal static UnityWebRequest CreateRequestToLoadUserHolograms() {
            ...
            byte[] jsonBytes = Encoding.ASCII.GetBytes(graphQLJson);

            UnityWebRequest request = UnityWebRequest.Post(api.endpoint + "/api/graphql", UnityWebRequest.kHttpVerbPOST);
